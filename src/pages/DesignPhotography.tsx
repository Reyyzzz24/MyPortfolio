...
const DesignPhotography = () => {
  ...
  return (
    ...
    <div className="bg-transparent text-gray-900 dark:text-gray-100 transition-colors duration-300 antialiased relative min-h-screen">
      ...
      <section id="design-layout" className="pt-32 pb-24 bg-transparent">
      ...
      <section id="photography" className="py-24 bg-gray-50/80 dark:bg-gray-900/20 backdrop-blur-sm border-t border-gray-100/10 dark:border-gray-800/50">
        <div className="container mx-auto px-6 md:px-12 max-w-7xl">
